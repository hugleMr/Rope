(function () {
    ...
    var devices = [
        ...
        { name: "Apple iPhone 6X", width: 442, height: 736, ratio: 3 },
        { name: "Apple iPhone 6XX", width: 450, height: 800, ratio: 3 },

        { name: "Apple iPad", width: 1024, height: 768, ratio: 2 },
        { name: "Apple iPad X", width: 587, height: 800, ratio: 2 },
        ...
        btnRecompile.addEventListener("click", function () {
            ...
            xmlHttp.onreadystatechange = function () {
                if (xmlHttp.readyState === 4 && xmlHttp.status === 200) {
                    document.getElementById("recompiling").style.display =
                        "block";
                }
            };
            ...
            cc.assetManager.loadAny(
                ...
                function (err, sceneAsset) {
                    ...
                    cc.assetManager.dependUtil._depends.add(
                        scene._id,
                        cc.assetManager.dependUtil._depends.get(
                            "preview-scene.json"
                        )
                    );
